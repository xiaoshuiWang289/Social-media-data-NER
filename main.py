...
print('main_max_seq_len',max_seq_len)
...
model = MECTNER(embeddings['lattice'], 
                embeddings['bigram'], 
                ...
                ff_size=args.ff)# 128x3  feed-forward中间层节点个数
...
# print(test_label_list,test_raw_char)
...
#     print(d)
    ...
    trainer.train()
    model_dir = "./{}/{}".format(args.save_path, args.dataset)
...
if args.status == "test":
    model_dir = "./{}/{}/2023_03_15_13_28_00".format(args.save_path, args.dataset)
    if not os.path.exists(model_dir):
        os.makedirs(model_dir)
    model_path = "{}/model_ckpt.pkl".format(model_dir)
    ...
    predict_path = "./results/ner_predict.utf8"
